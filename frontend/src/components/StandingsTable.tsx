      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-slate-800 text-slate-400 text-xs uppercase tracking-wider">
            ...
            <th className="px-3 py-3 text-center" title="Meciuri jucate">MJ</th>
            <th className="px-3 py-3 text-center" title="Victorii">V</th>
            <th className="px-3 py-3 text-center" title="Înfrângeri">Î</th>
            <th className="px-3 py-3 text-center" title="Seri câștigate">SC</th>
            <th className="px-3 py-3 text-center" title="Goluri marcate">GM</th>
        ...
        <tbody>
          {standings.map((row, i) => (
            <tr
              key={row.team_id}
              className={`border-t border-slate-700 transition-colors hover:bg-slate-800/50 ${
                i === 0 ? 'bg-green-950/30' : ''
              }`}
            >
              ...
              <td className="px-3 py-3 text-center text-slate-300">{row.matches_played}</td>
              ...
              <td className="px-3 py-3 text-center text-blue-400">{row.evenings_won}</td>
